      ...
      <section>
        <div className="flex flex-col md:flex-row items-center justify-between px-4 py-8">
          <div className="w-full text-center md:text-left md:w-1/2 md:ml-16">
            <h3 className="text-[#252B42] font-bold text-[16px] mb-6">ABOUT COMPANY</h3>
            <h1 className="text-[#252B42] font-bold text-[32px] sm:text-[48px] md:text-[58px] mb-6">ABOUT US</h1>
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <Image src="/aboutheros.png" alt="aboutus" height={280} width={415} className="w-full h-auto object-contain" />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-16 mt-16 w-full px-4 sm:px-0">
            {stats.map(({ value, label }) => (
              <div key={label} className="text-center">
                <h3 className="font-bold text-[#252B42] text-[48px] sm:text-[58px]">{value}</h3>
                <h2 className="font-bold text-[#737373] text-[14px] sm:text-[16px]">{label}</h2>
              </div>
            ))}
          </div>
          <div className="mt-16 sm:mt-20 w-full flex justify-center px-0">
            <Image src="/aboutvideo.png" alt="problem" width={800} height={500} className="w-full max-w-[100%] sm:max-w-none h-auto" />
          </div>
        </div>
      </section>
