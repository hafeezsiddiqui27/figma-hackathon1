...
const Footer = () => {
  return (
      <footer className="bg-white mt-10">
           <div className="flex h-20  bg-[#FAFAFA] text-gray-700 ">
           <h2 className="text-2xl font-bold text-gray-800 flex-col justify-center items-center mt-6 ml-12">Bandage</h2> </div>
